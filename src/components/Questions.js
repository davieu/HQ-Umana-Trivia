                  ...
                  <div className="col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                    <div className="card shadow mt-4 pt-3 pb-3">
                      <div className="card-body">
                        ...
                        <button disabled={this.state.currentAnswer != '' && this.state.currentAnswer != this.props.state.question.choices[0] ? true : false} className="btn btn-fill mt-2" type="button" onClick={()=> {this.submitAnswer(this.props.state.question.choices[0], this.props.socket.id)}}>{this.props.state.question.choices[0]}</button><br/>
